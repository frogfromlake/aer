...
Phase 129 (Documentation Sweep) explicitly verifies this discipline holds: the inventory is reconciled against the actual `scripts/` directory, `services/analysis-worker/main.py` extractor loops, and `.github/workflows/` files. Drift is treated as a documentation bug.
