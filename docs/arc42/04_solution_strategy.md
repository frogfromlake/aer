...
2. **Harmonization (Python):** An asynchronous job picks up the raw data, removes HTML boilerplate, standardizes timestamps, and structures the metadata. The data schema is unified (Silver Layer).
