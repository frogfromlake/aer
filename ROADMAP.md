...
* [ ] **`e2e_smoke_nightly.yml`** — currently failing; repaired as part of the E2E work below and kept as a scheduled (non-PR-blocking) smoke, OR retired if the in-CI E2E job covers it. No permanently-red scheduled workflow left standing.
