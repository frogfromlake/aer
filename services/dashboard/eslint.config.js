...
const FILE_LENGTH_ALLOWLIST = [
  ...
  ['**/ConfigValueLevers.svelte', 550] // Phase 148e — co-occurrence compact layout (3-col slider grid + grouped labels row incl. moved display-language) + editable Entities number field + scoped cluster CSS (column packing, fixed density slider + read-out width) (+16 over 530) — within the ±20-30 tolerance band
];
