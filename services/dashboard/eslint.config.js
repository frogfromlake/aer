...
const FILE_LENGTH_ALLOWLIST = [
  ...
  ['**/url-types.ts', 610], // URL state SoT — grows with each lever; Phase 149 added the `about` overlay field (+ EMPTY_URL_STATE default); Phase 148g added maxNodes + showLabels + provenanceBorder (+ compact pv keys); Phase 148e added defaultCompositionForView + initialLeversForView (the create-mode + pillar-seed SoT for co-occurrence opening merged with legible label/settle defaults)
